...
def data_update(request):
    ...
    # Configura el pin GPIO que estás utilizando
    pin_ldr = machine.Pin(26)  # Asegúrate de cambiar el número del pin según tu configuración
    adc = machine.ADC(pin_ldr)
    ...
    while True:
        ...
        return { "intensidad" : valor_analogico}

        # Espera un breve período antes de leer nuevamente
